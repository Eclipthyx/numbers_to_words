...
void rec_1(char *string, struct s_node **dict, int digit_count, int size)
{
	if(string[0] != '0')
	{
...
void rec_2(char *string, struct s_node **dict, int digit_count, int size)
{
...
void rec_3(char *string, struct s_node **dict, int digit_count, int size)
{
	if(string[0] != '0')
	{
		display_word(string, dict, 1, 2);
...
void rec(char *string, int size, struct s_node **dict)
{
	...
	{
		if(skip == 1)
			rec_1(string, dict, digit_count, size);
		else if(skip == 2)
			rec_2(string, dict, digit_count, size);
		else if(skip == 3)
			rec_3(string, dict, digit_count, size);
	}
}